...
import com.telstock.tmanager.proyectocursoandroid.adaptadores.AlbumRecyclerViewAdapter;
 ...
 */
public class AlbumesFavoritosFragment extends Fragment implements RecyclerViewOnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new AlbumRecyclerViewAdapter(getActivity(), albumList, this);
    ...
    public void obtenerCanciones(){
        List<Album> albumList = SugarRecord.listAll(Album.class);
        mAdapter = new AlbumRecyclerViewAdapter(getActivity(), albumList, this);
        rvLista.setAdapter(mAdapter);
    }
